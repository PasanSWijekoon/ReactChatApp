...
export function SignUp({navigation}) {
  ...
  const [profileimg ,profimg] = useState(null);
...
<Button title='Select photo' onPress={imguplodingdigdong} />
      ...
      <View style={styles.signupview1}>
        ...
        <TextInput style={styles.signupinput11} autoCorrect={false}  placeholder="Your User Name" onChangeText={setname}></TextInput>
      </View>
...
/>
  ...
  function loadcountries(){
    ...
    request.open('GET', 'http://10.0.2.2/react_chat_php/loadcountries.php', true);
    request.send();
...
var form = new FormData();
    ...
    form.append("name", namew);
    form.append("password", password);
    form.append("verifypassword", verifypassword);
    form.append("country", country);
    form.append("progimg", profileimg);
    ...
    r.open("POST", "http://10.0.2.2/react_chat_php/signup.php", true);
